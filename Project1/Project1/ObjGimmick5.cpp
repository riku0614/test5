...
CObjGimmick5::CObjGimmick5(float x, float y)
{
	gx = x;
	gy = y;
}
...
void CObjGimmick5::Action()
{
	...
	if (stop_flg == true && main->MapChangeData() == 4)
	{
		Hits::SetHitBox(this, gx, gy, 64, 64, ELEMENT_BLUE, OBJ_GIMMICK5, 1);
